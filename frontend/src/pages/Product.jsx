    ...
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='mt-20'>
        <div className='flex'>
          ...
          <p className='border px-5 py-3 text-sm text-gray-400'>
            Reviews (122)
          </p>
        </div>
        ...
        <div className='flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500'>
          <p>
            ...
            Necessitatibus, doloremque obcaecati culpa labore veniam.
          </p>
          <p>
            E-commerce website typically allows customers to browse products,
            add them to a shopping cart, and complete purchase online.
          </p>
        </div>
      </div>
